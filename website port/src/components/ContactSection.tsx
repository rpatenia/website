...
const EMAILJS_SERVICE_ID  = 'service_jsdfd7i';
const EMAILJS_TEMPLATE_ID = 'template_cic0teu';
const EMAILJS_PUBLIC_KEY  = '4AF14p7JzEhHsIrAk';

const socialLinks = [
  {
    name: 'GitHub',
    icon: GithubIcon,
    url: 'https://github.com/rpatenia',
    color: 'neonBlue',
  },
  {
    name: 'LinkedIn',
    icon: LinkedinIcon,
    url: 'https://www.linkedin.com/in/ryan-patenia-035790288/',
    color: 'neonPurple',
  },
  {
    name: 'Email',
    icon: MailIcon,
    url: 'ryanpatenia@gmail.com',
    color: 'neonCyan',
  },
];
    ...
    try {
      await emailjs.send(
        ...
        EMAILJS_TEMPLATE_ID,
        {
          ...
          name:       formData.name,    // {{name}} fallback in template
          email:      formData.email,   // {{email}} fallback in template
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="glass rounded-lg p-8 border border-neonPurple/20">
              <h3 className="text-2xl font-bold text-neonPurple mb-6">Connect With Me</h3>
              ...
              <div className="border-t border-gray-700 pt-6">
                <p className="text-gray-400 text-sm leading-relaxed">
                  Currently based in Philippines and open to remote opportunities worldwide.
